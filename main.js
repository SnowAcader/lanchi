...
var dialogs = {
    value0: function() {
        texts = "MI VIDA, HOLA,TE ESCRIBO MIENTRAS, EL PROGRAMA HACE TODO POR MI";
        timer = 400;
    },
    value1: function() {
    ...
    value8: function() {
        texts = "ME ENCANTO, RECUERDO CUANDO TE ABRACE MUY FUERTE";
        timer = 400;
    },
    value9: function() {
    ...
    value17: function() {
        texts = "MI COSHITA... MI BEBE...MI CIELITO";
        timer = 400;
    },
    value18: function() {
        texts = "ESTOY AQUI PARA TI SI";
        timer = 400;
    },
    value19: function() {
        texts = "ERES LA  MUJER QUE QUIERO PARA MI VIDA, SOLO TE QUIERO Y AMO A TI BEBE 😍❤";
        timer = 400;
    },
};
